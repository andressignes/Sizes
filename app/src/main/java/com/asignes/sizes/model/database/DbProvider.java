...
public class DbProvider extends ContentProvider {
  ...
  public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
    ...
    switch (uriMatcher.match(uri)) {
      case MOVIES:
        rowsUpdated =
            database.update(DbConstants.Movies.TABLE_NAME, values, selection, selectionArgs);
        break;
  ...
  public int delete(Uri uri, String selection, String[] selectionArgs) {
    ...
    switch (uriMatcher.match(uri)) {
      case MOVIES:
        rowsDeleted = database.delete(DbConstants.Movies.TABLE_NAME, selection, selectionArgs);
        break;
      ...
      case MOVIES_ID:
        ...
        if (TextUtils.isEmpty(selection)) {
          rowsDeleted =
              database.delete(DbConstants.Movies.TABLE_NAME, DbConstants.Movies.ID + "=" + id,
                  null);
        } else {
